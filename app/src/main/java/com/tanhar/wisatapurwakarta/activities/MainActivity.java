package com.tanhar.wisatapurwakarta.activities;
...
import com.tanhar.wisatapurwakarta.R;
import com.tanhar.wisatapurwakarta.adapter.MainAdapter;
import com.tanhar.wisatapurwakarta.decoration.LayoutMarginDecoration;
import com.tanhar.wisatapurwakarta.model.ModelMain;
import com.tanhar.wisatapurwakarta.utils.Tools;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
    ...
    public void onSelected(ModelMain mdlMain) {
        switch (mdlMain.getTxtName()) {
            case "Hotel":
                startActivityForResult(new Intent(MainActivity.this, com.tanhar.wisatapurwakarta.activities.HotelActivity.class), 1);
                break;
            case "Kuliner":
                startActivityForResult(new Intent(MainActivity.this, KulinerActivity.class), 1);
                break;
            case "Tempat Ibadah":
                startActivityForResult(new Intent(MainActivity.this, com.tanhar.wisatapurwakarta.activities.PrayPlaceActivity.class), 1);
                break;
            case "Wisata":
                startActivityForResult(new Intent(MainActivity.this, com.tanhar.wisatapurwakarta.activities.WisataActivity.class), 1);
                break;
        }
    }
